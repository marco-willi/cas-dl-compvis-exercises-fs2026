# Microsoft Cats vs Dogs — Classroom Subset v1.0
...
ImageNet normalisation and standard transforms apply as-is.
Images are variable size — use `transforms.Resize(256)` + `CenterCrop(224)`.
