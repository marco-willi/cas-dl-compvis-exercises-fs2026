...
The Özgenel et al. Concrete Crack Images dataset, restructured for classroom use
in the CAS Deep Learning — Computer Vision course exercises. Contains ~40,000
227×227 JPEG images of concrete surfaces labelled as cracked (Positive) or
...
- **Attribution:** Özgenel, Çağlar Fırat (2019). "Concrete Crack Images for Classification."
...
ImageNet normalisation and standard `Resize(256)` + `CenterCrop(224)` transforms apply as-is.
Images are already square 227×227 so resizing to 224 is minimal.
